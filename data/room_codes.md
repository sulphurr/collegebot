...
- **VG2**: ME Staff Room, Ground Floor, Mech Block.
...
- **VG6**: ME Staff Room 2, Ground Floor, Mech Block.
...
- **VF6**: ME Staff Room, First Floor, Mech Block.
...
### Second Floor
- **VS1**: Staff Room, Second Floor, Mech Block.
- **VS2**: Staff Room, Second Floor, Mech Block.
- **VS3**: Electrical Switch Room, Second Floor, Mech Block.
- **VS4**: Staff Toilet, Second Floor, Mech Block.
- **VS5**: ASH Department Staff Room, Second Floor, Mech Block.
...
- **VT4**: Staff Room, Third Floor, Mech Block.
...
- **VFF3**: Staff Room, Fourth Floor, Mech Block.
...
- **HOD Cybersecurity Room**: Cybersecurity Staff Room/HOD Office (Ms. Reema Mathew), Ground Floor, Admin Block (facing outdoor football ground).
...
- **G20**: CSD Staff Room, Ground Floor, Admin Block (facing indoor pond, near Reception).
...
- **G25**: Civil Staff Room, Ground Floor, Admin Block (facing Mech Block).
...
- **G30A**: Staff Room, Ground Floor, Admin Block (facing indoor pond, near Library).
...
### First Floor
- **F5**: Staff Room 2, First Floor, Admin Block (facing indoor basketball court, left from main stairs).
...
- **F32**: EEE StaffRoom, First Floor, Admin Block (facing indoor pond, corridor left of Library stairs).  
...
- **S14**: CSE StaffRoom, Second Floor, Admin Block (facing indoor pond, corridor straight from main stairs).  
...
- **S17**: CSE StaffRoom, Second Floor, Admin Block (facing indoor pond, corridor straight from main stairs).  
- **HOD CSE**: HOD CSE Room, Second Floor, Admin Block (facing indoor pond, corridor straight from main stairs).  
- **S19**: CSE Dept Library, Second Floor, Admin Block (facing indoor pond, corridor straight from main stairs).  
...
- **T10**: StaffRoom, Third Floor, Admin Block (corridor straight from main stairs).  
...
- **T17**: AEI StaffRoom, Third Floor, Admin Block (facing indoor pond, corridor straight from main stairs).  
...
- **T23**: CSE StaffRoom, Third Floor, Admin Block (facing indoor pond, left of Library stairs).  
...
- **Computer Lab-7 (Project Lab)**: Computer Lab-7 / Project Lab, Third Floor, Admin Block (facing indoor pond, left of Library stairs).  
